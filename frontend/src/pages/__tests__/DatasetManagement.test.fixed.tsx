...
// Remove userEvent import - use fireEvent instead
...
describe('DatasetManagement', () => {
  ...
  describe('empty state', () => {
    ...
    it('should show message when no tiger is selected', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText(/Select a tiger to view/i)).toBeInTheDocument()
      })
    })
  ...
  describe('add images functionality', () => {
    ...
    it('should display selected files', async () => {
      ...
      const fileInput = await screen.findByLabelText(/Select Images/i)
